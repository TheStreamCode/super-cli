...
These files cover the Super CLI identity only. Vendor and product marks used for built-in agents are
documented separately in [`media/agents/ATTRIBUTION.md`](../media/agents/ATTRIBUTION.md) and
