...
| CodeArts Agent CLI | Official Huawei logomark with radial gradient petals, with XML/web attributes removed and style tokens converted to SVG attributes | [Huawei brand logo](https://zonalogo.com/huawei-icon/) |
